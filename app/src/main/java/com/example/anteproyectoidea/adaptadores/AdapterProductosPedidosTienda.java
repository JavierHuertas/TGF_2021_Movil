...
public class AdapterProductosPedidosTienda extends BaseAdapter {

        private Context context;
        private List<ProductosCantidad> productosCantidads;

        public AdapterProductosPedidosTienda(Context context, List<ProductosCantidad> productosCantidads) {
